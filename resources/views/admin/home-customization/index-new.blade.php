            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" name="hero_visible" value="1" checked
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text"
                               name="hero_title"
                               id="hero_title"
                               value="{{ old('hero_title', $homeData['hero']['title'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="hero_subtitle"
                               id="hero_subtitle"
                               value="{{ old('hero_subtitle', $homeData['hero']['subtitle'] ?? '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="color"
                               ...
                               value="{{ old('hero_background_color', $homeData['hero']['background_color'] ?? '#2E7D32') }}"
        ...
        <div class="admin-card">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" name="about_visible" value="1" checked
                               class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Seção visível</span>
                    </label>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    <div>
                        ...
                        <input type="text"
                               name="about_title"
                               id="about_title"
                               value="{{ old('about_title', $homeData['about']['title'] ?? '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="about_subtitle"
                               id="about_subtitle"
                               value="{{ old('about_subtitle', $homeData['about']['subtitle'] ?? '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
        ...
        <div class="admin-card">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" name="events_visible" value="1" checked
                               class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Seção visível</span>
                    </label>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text"
                               name="events_title"
                               id="events_title"
                               value="{{ old('events_title', $homeData['events']['title'] ?? '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               id="events_subtitle"
                               value="{{ old('events_subtitle', $homeData['events']['subtitle'] ?? '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
            </div>
        ...
        <div class="admin-card">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" name="contact_visible" value="1" checked
                               class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Seção visível</span>
                    </label>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text"
                               name="contact_title"
                               id="contact_title"
                               value="{{ old('contact_title', $homeData['contact']['title'] ?? '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               id="contact_subtitle"
                               value="{{ old('contact_subtitle', $homeData['contact']['subtitle'] ?? '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea name="contact_content" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Texto adicional para exibir na seção de contato...">{{ old('contact_content', $homeData['contact']['content'] ?? '') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
