    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold">Editar Orixá: {{ $orisha->name }}</h1>
            ...
            <form method="POST" action="{{ route('admin.orishas.update', $orisha) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="flex items-center">
                    ...
                    <input type="checkbox"
                           ...
                           id="active"
                           value="1"
                           {{ old('active', $orisha->active) ? 'checked' : '' }}
