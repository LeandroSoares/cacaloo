...
@section('title', 'Adicionar Tipo de Magia')
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold">Adicionar Tipo de Magia</h1>
            ...
            <form method="POST" action="{{ route('admin.magic-types.store') }}" class="space-y-6">
                @csrf
