    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold">Editar Curso: {{ $course->name }}</h1>
            ...
            <form method="POST" action="{{ route('admin.courses.update', $course) }}" class="max-w-2xl">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="4"
                              ...
                              placeholder="Descrição opcional do curso...">{{ old('description', $course->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
