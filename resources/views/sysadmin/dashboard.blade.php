...
@section('title', 'Dashboard SysAdmin')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-purple-800 p-6 rounded-lg border border-purple-600 shadow">
                    ...
                    <div class="mt-4 flex space-x-3">
                        <a href="{{ route('sysadmin.permissions.index') }}" class="text-purple-300 hover:text-white">Ver todas →</a>
                    </div>
                </div>
                ...
                <div class="bg-purple-800 p-6 rounded-lg border border-purple-600 shadow">
                    ...
                    <div class="mt-4 flex space-x-3">
                        <a href="{{ route('sysadmin.system.logs') }}" class="text-purple-300 hover:text-white">Ver logs →</a>
                    </div>
                </div>
