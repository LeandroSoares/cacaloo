            ...
            <div class="space-y-8">
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            {{ config('centro.endereco.rua') }}<br>
                            {{ config('centro.endereco.cidade') }} - {{ config('centro.endereco.estado') }}<br>
                            CEP: {{ config('centro.endereco.cep') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <a href="tel:{{ config('centro.contato.telefone') }}" class="text-gray-600 hover:text-oxossi transition-colors">
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <a href="mailto:{{ config('centro.contato.email') }}" class="text-gray-600 hover:text-oxossi transition-colors break-all">
                ...
                <div class="bg-white rounded-lg shadow-soft overflow-hidden">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach(config('centro.horarios') as $dia => $horario)
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 text-gray-900">{{ $dia }}</td>
                                <td class="px-6 py-4 {{ $horario === 'Fechado' ? 'text-gray-400' : 'text-gray-600' }}">{{ $horario }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
