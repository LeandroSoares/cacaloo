...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    <head>
        ...
        <title>{{ config('app.name', 'Casa de Caridade Legião de Oxóssi e Ogum') }}</title>
    ...
    <body class="font-body text-gray-900 antialiased">
        ...
        <div class="min-h-screen relative overflow-hidden">
            ...
            <div class="absolute inset-0 z-0">
                <img
                    src="{{ asset('images/floresta2.jpg') }}"
                    alt=""
                    role="presentation"
            ...
            <div class="relative z-10 min-h-screen flex flex-col justify-center items-center py-8 sm:py-12 px-4">
                ...
                <div class="mb-6 sm:mb-8 mt-4 sm:mt-0">
                    <a href="{{ route('home') }}" class="flex flex-col items-center space-y-3 sm:space-y-4">
                        <img
                ...
                <!-- Voltar para Home -->
                <div class="mt-6">
                    <a href="{{ route('home') }}" class="text-white/80 hover:text-white font-medium transition-colors duration-300 text-sm flex items-center space-x-2">
