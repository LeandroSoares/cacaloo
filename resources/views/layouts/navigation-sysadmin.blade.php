<nav x-data="{ open: false }" class="bg-purple-900 text-white border-b border-purple-800">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('sysadmin.dashboard') }}" class="text-white font-bold text-xl">
                        SysAdmin
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('sysadmin.dashboard')" :active="request()->routeIs('sysadmin.dashboard')" class="text-white hover:text-purple-200">
                        {{ __('Dashboard') }}
                    </x-nav-link>

                    <x-nav-link :href="route('sysadmin.permissions.index')" :active="request()->routeIs('sysadmin.permissions.*')" class="text-white hover:text-purple-200">
                        {{ __('Permissões') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('sysadmin.dashboard')" :active="request()->routeIs('sysadmin.dashboard')" class="text-white hover:text-purple-200">
                {{ __('Dashboard') }}
        ...
        <div class="pt-4 pb-1 border-t border-purple-800">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('dashboard')" class="text-white hover:text-purple-200">
                    {{ __('Área do Usuário') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('admin.dashboard')" class="text-white hover:text-purple-200">
                    {{ __('Área Administrativa') }}
                </x-responsive-nav-link>
