...
// Adapta as cores do dropdown com base na rota atual
$isAdmin = request()->routeIs('admin.*');
$isSysAdmin = request()->routeIs('sysadmin.*');

if ($isAdmin) {
    $ringColor = 'ring-blue-700 ring-opacity-10';
} elseif ($isSysAdmin) {
    $ringColor = 'ring-purple-700 ring-opacity-10';
} else {
...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            style="display: none;"
            @click="open = false">
        <div class="rounded-md ring-1 <?php echo e($ringColor); ?> <?php echo e($contentClasses); ?>">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH C:\Users\leand\projects\cacaloo\resources\views/components/dropdown.blade.php ENDPATH**/ ?>