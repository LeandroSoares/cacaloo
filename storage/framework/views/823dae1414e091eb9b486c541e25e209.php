...
>
    <nav class="container mx-auto px-4 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <!-- Logo -->
            <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3 focus-ring rounded-lg">
                <img
...
<?php /**PATH C:\Users\leand\projects\cacaloo\resources\views/components/layout/header.blade.php ENDPATH**/ ?>