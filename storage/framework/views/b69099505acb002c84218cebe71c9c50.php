            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg border border-blue-200 shadow">
                    ...
                    <div class="mt-4 flex space-x-3">
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="text-blue-600 hover:text-blue-800">Ver todos →</a>
                        <a href="<?php echo e(route('admin.users.create')); ?>" class="text-green-600 hover:text-green-800">Adicionar novo +</a>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg border border-purple-200 shadow">
                    ...
                    <div class="mt-4 flex space-x-3">
                        <a href="<?php echo e(route('admin.roles.index')); ?>" class="text-purple-600 hover:text-purple-800">Ver todos →</a>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg border border-green-200 shadow">
                    ...
                    <div class="mt-4 flex space-x-3">
                        <a href="<?php echo e(route('admin.invitations.index')); ?>" class="text-green-600 hover:text-green-800">Ver todos →</a>
                        <a href="<?php echo e(route('admin.invitations.create')); ?>" class="text-green-600 hover:text-green-800">Enviar novo +</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leand\projects\cacaloo\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>