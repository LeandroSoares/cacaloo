...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> - SysAdmin - <?php echo $__env->yieldContent('title'); ?></title>
...
<body class="h-full font-sans antialiased sysadmin-area" style="background: var(--bg-primary);">
    <div class="min-h-full">
        <!-- Navegação -->
        <?php echo $__env->make('layouts.navigation-sysadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm font-medium" style="color: var(--text-primary);">
                                    Sistema Operacional - Laravel <?php echo e(app()->version()); ?>

                                </span>
                            </div>
                            <div class="text-xs" style="color: var(--text-secondary);">
                                Última atualização: <?php echo e(now()->format('d/m/Y H:i:s')); ?>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p style="color: var(--text-light);" class="text-sm">
                            © <?php echo e(date('Y')); ?> Casa de Caridade - Sistema de Administração
                        </p>
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-xs text-gray-400">
                            Sessão: <?php echo e(substr(session()->getId(), 0, 8)); ?>...
                        </span>
...
<?php /**PATH C:\Users\leand\projects\cacaloo\resources\views/layouts/sysadmin.blade.php ENDPATH**/ ?>